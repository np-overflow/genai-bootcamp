...
BOT_TOKEN = "MTIxNTUwODU0MjU4OTc3MTg4Ng.GXdRq3.n3HASiX9cNKL3hNneFpk_W1DnAhEMWhi_1m_Oc"
batch_sz = 64
epoch = 100
latent_dim = 256
num_samples = 10000
...
# Padding of sequences to a maximum length, denoted len
...
# ------------------------------------------------------------------
# Dictionaries map each char, to its index in the vocab
# For example, if the char 'a' has index 0 in the input vocab, 
# input_token_index['a'] returns 0.
...
# Storing One-Hot Encoded Representation of input-output pairs
# ------------------------------------------------------------------
...
@bot.tree.command(description="Translate")
